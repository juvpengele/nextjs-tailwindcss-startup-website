...
export default function HomeCta() { 
    return (
        <div className="py-20 px-6 my-8 flex flex-col items-center justify-center bg-blue-600 rounded-xl text-white">
            <h4 className="w-full lg:w-1/3 xl:w-1/4 text-3xl text-center font-bold leading-normal">Online Security For You & Your Family</h4>
